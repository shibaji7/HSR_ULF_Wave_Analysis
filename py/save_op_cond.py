...
def draw_interpolated_conductance(new_mlat_grid, new_mlt_grid, dt, hemi,fluxtypes=['diff','mono']):
    """
...
def save_wave_event_cond_batch(fn_wave='wave_info_db/201507_v_los_igrf.csv',
                               ...
                               hemi='N',homedir='/home/xueling/',fluxtypes=['diff','mono','wave']):
...
if __name__ == "__main__":
    ...
    event_fnames = ['201501_v_los_igrf','201502_v_los_igrf',
                    '201503_v_los_igrf','201504_v_los_igrf',
                    '201505_v_los_igrf','201506_v_los_igrf',
                    '201507_v_los_igrf','201508_v_los_igrf',
                    '201509_v_los_igrf','201510_v_los_igrf',
                    '201511_v_los_igrf','201512_v_los_igrf']
    for fn in event_fnames:
        t = time.time()
        fn_wave=main_dir+fn+'.csv'
        fn_new=main_dir+fn+'_new.csv'
        save_wave_event_cond_batch(fn_wave=fn_wave,fn_new=fn_new,hemi='N',
                                   homedir='/home/xueling/op_cond_meta/',fluxtypes=['diff','mono','wave'])
